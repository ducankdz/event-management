...
public class AuthServiceImpl implements AuthService{
    ...
    public User register(AuthDTO authDTO) throws Exception {
        ...
        Role role = roleRepository.findById(authDTO.getRoleId())
    ...
    public String login(AuthDTO authDTO) throws Exception {
        ...
        if (!user.isVerified()) {
            throw new RuntimeException("Your email has not been verified. Please verify your email before logging in.");
        }
